...
(function ($) {
    ...
    function dispatchTimer() {
        timer = {
            total: Math.floor((settings.end - settings.start) / 1000 / 86400),
            days: Math.floor((settings.end - settings.now ) / 1000 / 86400),
            hours: 24 - Math.floor(((settings.end - settings.now) % 86400000) / 1000 / 3600),
            minutes: 60 - Math.floor(((((settings.end - settings.now) / 1000) % 86400) % 3600) / 60),
            seconds: 60 - Math.floor(((((settings.end - settings.now) / 1000) % 86400) % 3600 ) % 60 )
        }
    }
