...
wx.ready(function () {
	  ...
	  jQuery('#checkJsApi').bind("click", function () {
	    wx.checkJsApi({
	      jsApiList: [
	        'getNetworkType',
	        'previewImage'
...
wx.ready(function () {
  ...
  jQuery('#onMenuShareAppMessage').bind("click", function () {
  ...
  jQuery('#onMenuShareTimeline').bind("click", function () {
  ...
  jQuery('#onMenuShareQQ').bind("click", function () {
    wx.onMenuShareQQ({
      title: '互联网之子',
      desc: '在长大的过程中，我才慢慢发现，我身边的所有事，别人跟我说的所有事，那些所谓本来如此，注定如此的事，它们其实没有非得如此，事情是可以改变的。更重要的是，有些事既然错了，那就该做出改变。',
      link: 'http://movie.douban.com/subject/25785114/',
  ...
  jQuery('#onMenuShareWeibo').bind("click", function () {
    wx.onMenuShareWeibo({
      title: '互联网之子',
      desc: '在长大的过程中，我才慢慢发现，我身边的所有事，别人跟我说的所有事，那些所谓本来如此，注定如此的事，它们其实没有非得如此，事情是可以改变的。更重要的是，有些事既然错了，那就该做出改变。',
      link: 'http://movie.douban.com/subject/25785114/',
  ...
  jQuery('#onMenuShareQZone').bind("click", function () {
    wx.onMenuShareQZone({
      title: '互联网之子',
      desc: '在长大的过程中，我才慢慢发现，我身边的所有事，别人跟我说的所有事，那些所谓本来如此，注定如此的事，它们其实没有非得如此，事情是可以改变的。更重要的是，有些事既然错了，那就该做出改变。',
      link: 'http://movie.douban.com/subject/25785114/',
  ...
  // 3.1 识别音频并返回识别结果
  jQuery('#translateVoice').bind("click", function () {
    if (voice.localId == '') {
  ...
  // 4 音频接口
  // 4.2 开始录音
  jQuery('#startRecord').bind("click", function () {
    wx.startRecord({
      cancel: function () {
        alert('用户拒绝授权录音');
      }
  ...
  // 4.3 停止录音
  jQuery('#stopRecord').bind("click", function () {
    wx.stopRecord({
      success: function (res) {
  ...
  // 4.5 播放音频
  jQuery('#playVoice').bind("click", function () {
    if (voice.localId == '') {
      alert('请先使用 startRecord 接口录制一段声音');
      return;
    }
  ...
  // 4.6 暂停播放音频
  jQuery('#pauseVoice').bind("click", function () {
    wx.pauseVoice({
      localId: voice.localId
    });
  });
  ...
  // 4.7 停止播放音频
  jQuery('#stopVoice').bind("click", function () {
    wx.stopVoice({
      localId: voice.localId
    });
  });
  ...
  // 4.8 上传语音
  jQuery('#uploadVoice').bind("click", function () {
    if (voice.localId == '') {
      alert('请先使用 startRecord 接口录制一段声音');
      return;
    }
  ...
  // 4.9 下载语音
  jQuery('#downloadVoice').bind("click", function () {
    if (voice.serverId == '') {
  ...
  jQuery('#chooseImage').bind("click", function () {
    wx.chooseImage({
      success: function (res) {
  ...
  // 5.2 图片预览
  jQuery('#previewImage').bind("click", function () {
    wx.previewImage({
  ...
  // 5.4 下载图片
  jQuery('#downloadImage').bind("click", function () {
  ...
  // 6 设备信息接口
  // 6.1 获取当前网络状态
  jQuery('#getNetworkType').bind("click", function () {
    wx.getNetworkType({
      success: function (res) {
  ...
  // 7 地理位置接口
  // 7.1 查看地理位置
  jQuery('#openLocation').bind("click", function () {
    wx.openLocation({
      latitude: 23.099994,
  ...
  // 7.2 获取当前地理位置
  jQuery('#getLocation').bind("click", function () {
    wx.getLocation({
      success: function (res) {
        alert(JSON.stringify(res));
      },
  ...
  // 8 界面操作接口
  // 8.1 隐藏右上角菜单
  jQuery('#hideOptionMenu').bind("click", function () {
    wx.hideOptionMenu();
  });

  // 8.2 显示右上角菜单
  jQuery('#showOptionMenu').bind("click", function () {
    wx.showOptionMenu();
  });

  // 8.3 批量隐藏菜单项
  jQuery('#hideMenuItems').bind("click", function () {
    wx.hideMenuItems({
      menuList: [
  ...
  // 8.4 批量显示菜单项
  jQuery('#showMenuItems').bind("click", function () {
    wx.showMenuItems({
      menuList: [
        'menuItem:readMode', // 阅读模式
        'menuItem:share:timeline', // 分享到朋友圈
  ...
  // 8.5 隐藏所有非基本菜单项
  jQuery('#hideAllNonBaseMenuItem').bind("click", function () {
  ...
  // 8.6 显示所有被隐藏的非基本菜单项
  jQuery('#showAllNonBaseMenuItem').bind("click", function () {
  ...
  // 8.7 关闭当前窗口
  jQuery('#closeWindow').bind("click", function () {
    wx.closeWindow();
  });

  // 9 微信原生接口
  // 9.1.1 扫描二维码并返回结果
  jQuery('#scanQRCode0').bind("click", function () {
    wx.scanQRCode();
  });
  // 9.1.2 扫描二维码并返回结果
  jQuery('#scanQRCode1').bind("click", function () {
    wx.scanQRCode({
      needResult: 1,
  ...
  // 10 微信支付接口
  // 10.1 发起一个支付请求
  jQuery('#chooseWXPay').bind("click", function () {
  ...
  // 11.3  跳转微信商品页
  jQuery('#openProductSpecificView').bind("click", function () {
  ...
  // 12 微信卡券接口
  // 12.1 添加卡券
  jQuery('#addCard').bind("click", function () {
    wx.addCard({
      cardList: [
        {
  ...
  var codes = [];
  // 12.2 选择卡券
  jQuery('#chooseCard').bind("click", function () {
    wx.chooseCard({
  ...
  // 12.3 查看卡券
  jQuery('#openCard').bind("click", function () {
    if (codes.length < 1) {
